      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-block">
            <span className="inline-block w-12 h-1 bg-highlight-500 mb-4 rounded-full"></span>
            <h2 className="text-4xl lg:text-5xl font-bold text-contrast-800 mb-4">
              {title}
            </h2>
        ...
        <div className="text-center">
          <Link
            ...
            className={`group inline-flex items-center gap-2 bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 ${isRTL ? 'flex-row-reverse' : ''}`}
          >
            <span>{t('viewAll')}</span>
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-32 w-64 h-64 bg-highlight-100 rounded-full opacity-20 blur-3xl" />
        <div className="absolute top-3/4 -right-32 w-64 h-64 bg-primary-100 rounded-full opacity-20 blur-3xl" />
      </div>
