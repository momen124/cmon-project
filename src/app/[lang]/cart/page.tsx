      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        {cart.length > 0 && (
          <button
            ...
            className={`flex items-center gap-2 text-red-600 dark:text-red-300 hover:text-red-700 dark:hover:text-red-200 hover:bg-red-50 dark:hover:bg-red-900/20 px-4 py-2 rounded-lg transition-colors border border-red-200 dark:border-red-900/50 font-english ${isRTL ? 'space-x-reverse' : ''}`}
          >
                  ...
                  {cart.map((item) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="p-2 text-red-600 dark:text-red-300 hover:bg-[var(--hover-bg-color)] rounded transition-colors"
